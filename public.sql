...
-- ----------------------------
-- Sequence structure for material_issuing_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."material_issuing_id_seq";
CREATE SEQUENCE "public"."material_issuing_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for material_issuing_lots_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."material_issuing_lots_id_seq";
CREATE SEQUENCE "public"."material_issuing_lots_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for material_receiving_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."material_receiving_id_seq";
CREATE SEQUENCE "public"."material_receiving_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for material_receiving_lots_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."material_receiving_lots_id_seq";
CREATE SEQUENCE "public"."material_receiving_lots_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Sequence structure for material_transactions_id_seq
-- ----------------------------
...
-- ----------------------------
-- Table structure for material_issuing
-- ----------------------------
DROP TABLE IF EXISTS "public"."material_issuing";
CREATE TABLE "public"."material_issuing" (
  "id" int4 NOT NULL DEFAULT nextval('material_issuing_id_seq'::regclass),
  "issuing_no" varchar(50) COLLATE "pg_catalog"."default" NOT NULL,
  "issuing_date" timestamp(6) NOT NULL,
  "material_id" int4,
  ...
  "work_order_no" varchar(50) COLLATE "pg_catalog"."default",
...
-- ----------------------------
-- Table structure for material_issuing_lots
-- ----------------------------
DROP TABLE IF EXISTS "public"."material_issuing_lots";
CREATE TABLE "public"."material_issuing_lots" (
  "id" int4 NOT NULL DEFAULT nextval('material_issuing_lots_id_seq'::regclass),
  "issuing_id" int4,
  "lot_id" int4,
  "qr_code" varchar(100) COLLATE "pg_catalog"."default" NOT NULL,
...
-- ----------------------------
-- Table structure for material_receiving
-- ----------------------------
DROP TABLE IF EXISTS "public"."material_receiving";
CREATE TABLE "public"."material_receiving" (
  "id" int4 NOT NULL DEFAULT nextval('material_receiving_id_seq'::regclass),
  "receiving_no" varchar(50) COLLATE "pg_catalog"."default" NOT NULL,
  "receiving_date" timestamp(6) NOT NULL,
  "supplier_id" int4,
  "material_id" int4,
  "total_quantity" numeric(15,2) NOT NULL,
  "unit" varchar(50) COLLATE "pg_catalog"."default",
  "po_no" varchar(50) COLLATE "pg_catalog"."default",
  "remark" text COLLATE "pg_catalog"."default",
...
-- ----------------------------
-- Table structure for material_receiving_lots
-- ----------------------------
DROP TABLE IF EXISTS "public"."material_receiving_lots";
CREATE TABLE "public"."material_receiving_lots" (
  "id" int4 NOT NULL DEFAULT nextval('material_receiving_lots_id_seq'::regclass),
  "receiving_id" int4,
  "lot_no" varchar(50) COLLATE "pg_catalog"."default" NOT NULL,
  "qr_code" varchar(100) COLLATE "pg_catalog"."default" NOT NULL,
  "material_id" int4,
  "quantity" numeric(15,2) NOT NULL,
  ...
  "location_id" int4,
  "expiry_date" date,
  "status" varchar(20) COLLATE "pg_catalog"."default" DEFAULT 'AVAILABLE'::character varying,
  "create_date" timestamp(6) DEFAULT now(),
  "create_by" varchar(255) COLLATE "pg_catalog"."default"
)
;
...
CREATE TABLE "public"."material_transactions" (
  "id" int4 NOT NULL DEFAULT nextval('material_transactions_id_seq'::regclass),
  ...
  "material_id" int4,
  "lot_id" int4,
  "qr_code" varchar(100) COLLATE "pg_catalog"."default",
  "quantity" numeric(15,2) NOT NULL,
  "remaining_quantity" numeric(15,2),
  "reference_no" varchar(50) COLLATE "pg_catalog"."default",
  "remark" text COLLATE "pg_catalog"."default",
  "create_date" timestamp(6) DEFAULT now(),
  "create_by" varchar(255) COLLATE "pg_catalog"."default"
)
...
SELECT setval('"public"."items_name_id_seq"', 22, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."material_issuing_id_seq"
OWNED BY "public"."material_issuing"."id";
SELECT setval('"public"."material_issuing_id_seq"', 1, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."material_issuing_lots_id_seq"
OWNED BY "public"."material_issuing_lots"."id";
SELECT setval('"public"."material_issuing_lots_id_seq"', 3, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."material_receiving_id_seq"
OWNED BY "public"."material_receiving"."id";
SELECT setval('"public"."material_receiving_id_seq"', 29, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."material_receiving_lots_id_seq"
OWNED BY "public"."material_receiving_lots"."id";
SELECT setval('"public"."material_receiving_lots_id_seq"', 14752, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."material_transactions_id_seq"
OWNED BY "public"."material_transactions"."id";
SELECT setval('"public"."material_transactions_id_seq"', 14749, true);
...
SELECT setval('"public"."materials_id_seq"', 22, true);
...
SELECT setval('"public"."supplier_id_seq"', 10, true);
...
-- ----------------------------
-- Uniques structure for table material_issuing
-- ----------------------------
ALTER TABLE "public"."material_issuing" ADD CONSTRAINT "material_issuing_issuing_no_key" UNIQUE ("issuing_no");

-- ----------------------------
-- Primary Key structure for table material_issuing
-- ----------------------------
ALTER TABLE "public"."material_issuing" ADD CONSTRAINT "material_issuing_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table material_issuing_lots
-- ----------------------------
CREATE INDEX "idx_issuing_lots_qr" ON "public"."material_issuing_lots" USING btree (
  "qr_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table material_issuing_lots
-- ----------------------------
ALTER TABLE "public"."material_issuing_lots" ADD CONSTRAINT "material_issuing_lots_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Uniques structure for table material_receiving
-- ----------------------------
ALTER TABLE "public"."material_receiving" ADD CONSTRAINT "material_receiving_receiving_no_key" UNIQUE ("receiving_no");

-- ----------------------------
-- Primary Key structure for table material_receiving
-- ----------------------------
ALTER TABLE "public"."material_receiving" ADD CONSTRAINT "material_receiving_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table material_receiving_lots
-- ----------------------------
CREATE INDEX "idx_receiving_lots_fifo" ON "public"."material_receiving_lots" USING btree (
  "material_id" "pg_catalog"."int4_ops" ASC NULLS LAST,
  "create_date" "pg_catalog"."timestamp_ops" ASC NULLS LAST,
  "status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "idx_receiving_lots_material" ON "public"."material_receiving_lots" USING btree (
  "material_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "idx_receiving_lots_qr" ON "public"."material_receiving_lots" USING btree (
  "qr_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "idx_receiving_lots_status" ON "public"."material_receiving_lots" USING btree (
  "status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table material_receiving_lots
-- ----------------------------
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_lot_no_key" UNIQUE ("lot_no");
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_qr_code_key" UNIQUE ("qr_code");

-- ----------------------------
-- Primary Key structure for table material_receiving_lots
-- ----------------------------
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table material_transactions
-- ----------------------------
CREATE INDEX "idx_transactions_lot" ON "public"."material_transactions" USING btree (
  "lot_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "idx_transactions_qr" ON "public"."material_transactions" USING btree (
  "qr_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table material_transactions
-- ----------------------------
ALTER TABLE "public"."material_transactions" ADD CONSTRAINT "material_transactions_transaction_no_key" UNIQUE ("transaction_no");

-- ----------------------------
-- Primary Key structure for table material_transactions
-- ----------------------------
ALTER TABLE "public"."material_transactions" ADD CONSTRAINT "material_transactions_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
-- Foreign Keys structure for table material_issuing
-- ----------------------------
ALTER TABLE "public"."material_issuing" ADD CONSTRAINT "material_issuing_material_id_fkey" FOREIGN KEY ("material_id") REFERENCES "public"."materials" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table material_issuing_lots
-- ----------------------------
ALTER TABLE "public"."material_issuing_lots" ADD CONSTRAINT "material_issuing_lots_issuing_id_fkey" FOREIGN KEY ("issuing_id") REFERENCES "public"."material_issuing" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "public"."material_issuing_lots" ADD CONSTRAINT "material_issuing_lots_lot_id_fkey" FOREIGN KEY ("lot_id") REFERENCES "public"."material_receiving_lots" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table material_receiving
-- ----------------------------
ALTER TABLE "public"."material_receiving" ADD CONSTRAINT "material_receiving_material_id_fkey" FOREIGN KEY ("material_id") REFERENCES "public"."materials" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "public"."material_receiving" ADD CONSTRAINT "material_receiving_supplier_id_fkey" FOREIGN KEY ("supplier_id") REFERENCES "public"."supplier" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table material_receiving_lots
-- ----------------------------
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_location_id_fkey" FOREIGN KEY ("location_id") REFERENCES "public"."materials_location" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_material_id_fkey" FOREIGN KEY ("material_id") REFERENCES "public"."materials" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "public"."material_receiving_lots" ADD CONSTRAINT "material_receiving_lots_receiving_id_fkey" FOREIGN KEY ("receiving_id") REFERENCES "public"."material_receiving" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table material_transactions
-- ----------------------------
ALTER TABLE "public"."material_transactions" ADD CONSTRAINT "material_transactions_lot_id_fkey" FOREIGN KEY ("lot_id") REFERENCES "public"."material_receiving_lots" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "public"."material_transactions" ADD CONSTRAINT "material_transactions_material_id_fkey" FOREIGN KEY ("material_id") REFERENCES "public"."materials" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "public"."materials" ADD CONSTRAINT "fk_materials_supplier" FOREIGN KEY ("supplier_id") REFERENCES "public"."supplier" ("id") ON DELETE SET NULL ON UPDATE NO ACTION;
