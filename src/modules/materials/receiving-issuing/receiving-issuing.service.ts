  ...
  async getAllReceivings(
    ...
    if (search) {
      queryBuilder.andWhere(
        '(receiving.receivingNo ILIKE :search OR receiving.poNo ILIKE :search OR material.matCode ILIKE :search OR material.matName ILIKE :search OR supplier.name ILIKE :search)',
        { search: `%${search}%` }
      );
    }
